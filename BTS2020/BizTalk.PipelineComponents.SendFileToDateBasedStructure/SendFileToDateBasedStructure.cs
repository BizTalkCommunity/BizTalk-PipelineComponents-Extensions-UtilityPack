namespace BizTalk.PipelineComponents.SendFileToDateBasedStructure
{
    using System;
    using System.IO;
    using System.Text;
    ...
    [System.Runtime.InteropServices.Guid("15ac0a25-3eaa-4110-a8fd-c740e32f172d")]
    [ComponentCategory(CategoryTypes.CATID_Encoder)]
    public class SendFileToDateBasedStructure : Microsoft.BizTalk.Component.Interop.IComponent, IBaseComponent, IPersistPropertyBag, IComponentUI
    {
        
        private System.Resources.ResourceManager _resourceManager = new System.Resources.ResourceManager("BizTalk.PipelineComponents.SendFileToDateBasedStructure.SendFileToDateBasedStructure", Assembly.GetExecutingAssembly());
        ...
        {
            classID = new System.Guid("15ac0a25-3eaa-4110-a8fd-c740e32f172d");
        }
        ...
        public Microsoft.BizTalk.Message.Interop.IBaseMessage Execute(Microsoft.BizTalk.Component.Interop.IPipelineContext pContext, Microsoft.BizTalk.Message.Interop.IBaseMessage pInMsg)
        {
            ...
            try
            {
                if (this.Enabled)
                {
                    if (pInMsg.Context.Read("OutboundTransportType", "http://schemas.microsoft.com/BizTalk/2003/system-properties").ToString() == "FILE")
                    {
                        string basePath = pInMsg.Context.Read("OutboundTransportLocation", "http://schemas.microsoft.com/BizTalk/2003/system-properties").ToString();
                        string fullPath = Path.Combine(Path.GetDirectoryName(basePath), DateTime.Now.ToString(@"yyyy\\MM\\dd"));
                        Directory.CreateDirectory(fullPath);
                        pInMsg.Context.Promote("OutboundTransportLocation", "http://schemas.microsoft.com/BizTalk/2003/system-properties", Path.Combine(fullPath, Path.GetFileName(basePath)));
                    }
                }
            }
            catch(Exception ex)
